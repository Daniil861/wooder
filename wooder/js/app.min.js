...
let myImageSlider = new Swiper('.header__slider', {
	navigation: {
	...
	pagination: {
		...
		//Добавляем номер слайда внутрь буллета
		renderBullet: function (index, className) {
			return '<span class="' + className + '">' + (index + 1) + '</span>';
		},*/
		/*
		type: 'fraction',
		//к цифрам добавляем немного слов
	...
	*/
	...
	// Мультирядность - не работает почему-то(нижний ряд не отображается)
	slidesPerColumn: 1,

	// Бесконечный слайдер
	loop: true,

	// Кол-во дублирующих слайдов - нужно в случае если значение slidesPerView: auto
	loopedSlides: 3,

	// Свободный режим (позволяет прокручивать слайдер как ленту, 
	//нет четкого понимания что прокручиваются отдельные слайды)
	freeMode: false,
	...
	autoplay: {
		...
		delay: 1500,
		// Закончить на последнем слайде (если включена бесконечность - 
		//автопрокрутка будет все равно работать)
	...
	*/
	...
	// Вертикальный слайдер (нужно обязательно задать высоту слайдера)
	direction: 'horizontal', // указать значение vertical horizontal
	...
	*/
	...
	/*
	// Эффекты переключения слайдов.
	// Куб (нужно ограничин ширину всего слайдера)
	effect: 'cube',
	...
	*/
	...
	breakpoints: {
		320: {
			slidesPerView: 1,
			// в брейкпойнты можно указывать и другие свойства
			// кроме смены с горизонтального на вертикальный
		},
		480: {
			slidesPerView: 2,
		},
	...
	*/
	...
	/*
	// Зум картинки (работает плохо, не удобно)
	zoom: {
	...
	*/
	...
	// Обновить свайпер (необходимо в случаях когда свайпер спрятан в табе, иначе работать не будет)
